...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(() => {
  var getValue = function() {fetch("https://wordwatch-api.herokuapp.com/api/v1/top_word")
    ...
    .then(results => {
      ...
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#word').text(`${upWord}`);
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#count').text(`${count}`);
    });
  }
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#breakdown').on('click', function () {
    let value = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("textarea").val()
    alert(value + " was submitted!")
    var words = value.split(" ")
    for (let counter = 0; counter < words.length; counter++) {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.post("https://wordwatch-api.herokuapp.com/api/v1/words", { word: { value: words[counter] } })
        .done(response => {
